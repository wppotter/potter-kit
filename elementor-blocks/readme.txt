...
Elementor Blocks is a simple yet powerful WordPress plugin that allows you to create a layout with Elementor and set it as
- Header
- Footer
...
<ul>
	...
	<li><strong>Copyright</strong> - It offers constants to display copyright notice - [peb_current_year] and [peb_site_title].</li>
	<li><strong>Search</strong> - Add a search form to your with different layout and styling options.</li>
</ul>

= WORKS WITH ALL THEMES =

Elementor Blocks plugin works with all WordPress themes. Few of the themes have direct support while for few you can choose a method to add theme support.

In case you face any difficulty displaying header/footer, manually choose the theme support method. Visit Appearance > Elementor Blocks > Theme Support. Select a method to suit your current theme and you are good to go!

= STEPS TO USE THE PLUGIN =

Step 1 - Visit Appearance > Elementor Blocks and click on the ‘Add New’.
...
You can refer to our step-by-step article that will help you [set Elementor headers and footers](https://uaelementor.com/header-footer-with-elementor/?utm_source=wp-repo&utm_campaign=potter-elementor-blocks&utm_medium=description) quickly.

= LOOKING FOR PREMIUM ELEMENTOR ADDONS AND WIDGETS? =

Check [Ultimate Addons for Elementor](https://uaelementor.com/?utm_source=wp-repo&utm_campaign=potter-elementor-blocks&utm_medium=description). It is a library of creative and unique Elementor widgets that add more functionality and flexibility to your favorite page builder.

= HAVE YOU TRIED ASTRA WITH ELEMENTOR? =

Powering over 800,000+ WordPress websites, Potter is loved for the performance and ease-of-use it offers.

People love Potter for -

**Better Performance** - Optimized code and modular architecture make Potter the most lightweight theme for a faster loading website!

**Page Builder's Best Friend** - Potter works great with all page builders. Its support for custom layouts, Elementor templates, and ready-made starter sites makes it the best [theme for Elementor](https://wppotter.com/theme-for-elementor/?utm_source=wp-repo&utm_medium=potter_desc&utm_campaign=header_footer_elementor).

**Ready-to-use complete website templates** - Potter offers free ready-made website demos built with Elementor. You can choose any of the [Elementor Templates](https://wppotter.com/elementor-templates-free-downloads/ "Elementor Templates"), tweak them as you want and go live in minutes!

= SUPPORTED & ACTIVELY DEVELOPED =
Need help with something? Have an issue to report? Visit [Plugin’s Forum](https://wordpress.org/plugins/potter-elementor-blocks/ "Plugin’s Forum").

[Get in touch](https://github.com/Nikschavan/potter-elementor-blocks "Elementor - Elementor Blocks on GitHub") with us on GitHub.

Made with love at [Brainstorm Force](https://www.brainstormforce.com/?utm_source=wp-repo&utm_campaign=potter-elementor-blocks&utm_medium=description "Brainstorm Force")!

== Installation ==

1. Go to `Plugins -> Add New` and search for Elementor Blocks Template.
2. Activate the plugin through the 'Plugins' screen in WordPress.
3. Go to `Appearance -> Elementor Blocks` to build a header or footer layout using Elementor.
...
1. Go to Appearance -> Elementor Blocks to build a header or footer layout using Elementor.
...
The Elementor Blocks Template plugin just gives you a container where you can completely design the header using Elementor Page Builder, So the process of creating the mobile responsive layout is exactly the same as you would create a responsive layout of your other Elementor page.
...
1. Go to Appearance -> Elementor Blocks to create a new template.
...
5. Default widgets available with Elementor Blocks.
...
= 1.4.1 =
- Fix: EHF header overlapping Potter WooCommerce Off-Canvas.
...
- Improvement: Allow before footer to work on Elementor Canvas Template when not using Potter Theme.
...
= 1.1.3 =
- Improvement: Allow changing the permalinks for the peb templates (<a href="https://github.com/Nikschavan/potter-elementor-blocks/pull/162/">#162</a>)
- Fix: WPML Translations do not work when using the Elementor Template as a shortcode. (<a href="https://github.com/Nikschavan/potter-elementor-blocks/pull/159/">#159</a>)
- Fix: Page content appears over the header. (<a href="https://github.com/Nikschavan/potter-elementor-blocks/pull/150/">#150</a>)
- Fix: Remove the deprecated function warning for shortcode functions. (Props <a href="https://github.com/hogash">@hogash</a> <a href="https://github.com/Nikschavan/potter-elementor-blocks/pull/145/">#145</a>)
...
= 1.1.0 =
- New: Rename plugin to be Elementor Blocks builder as now thee blocks templates can be used as shortcodes.
- New: Add templates before the footer for Potter Theme. Options for other themes will be coming soon.
...
- Introduced helper functions for rendering and checking the headers to make it simpler to integrate PEB with more themes.

= 1.0.1 =
- New: Added support for the <a href="https://wppotter.com/?utm_source=wp-repo&utm_campaign=bb-header-footer&utm_medium=description-changelog">Potter</a> WordPress theme - The Fastest, Most Lightweight &amp; Customizable WordPress Theme.
